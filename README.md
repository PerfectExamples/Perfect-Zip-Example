# Perfect Zip / Unzip Files Example
...
* Open `PerfectZipExample.xcodeproj`
* Select the Executable build target from the schemes dropdown in Xcode
* Edit the Scheme, Under "Options" for "Run", check "Use custom working directory" and choose the project's working directory.
...
* Execute `swift build`
* Once the project has compiled, execute `./.build/debug/PerfectZipExample`
